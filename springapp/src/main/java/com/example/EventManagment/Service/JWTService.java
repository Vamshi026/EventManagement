...
public class JWTService {
    ...
    public String generateToken(String email, String userrole) {
        ...
        return Jwts.builder()
                ...
                .expiration(new Date(System.currentTimeMillis() + (60*60*1000*24)))   //(60*60*1000*30)
                .and()
                .signWith(getKey())
                .compact();
    ...
    public String extractUserName(String token) {
        // Logging before extracting the username
    ...
    private Claims extractAllClaims(String token) {
        System.out.println("Logging before parsing the claims");
        return Jwts.parser()
                .verifyWith(getKey())
                .build()
